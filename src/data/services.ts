...
export const SERVICE_TIERS: ServiceTier[] = [
  ...
  {
    id: 'haul_away',
    nameAr: 'سحب الجهاز القديم',
    nameEn: 'Old appliance haul-away',
    taglineAr: 'خدمة مدفوعة يؤديها نفس الطاقم عند الباب — تضيف هامشاً دون المساس بمجانية التوصيل',
    taglineEn: 'A paid add-on performed by the crew already at the door — adds margin without touching the free-delivery promise',
    status: 'planned',
    slaHours: 48,
    windowMinutes: 180,
    customerPrice: 60,
    costToServe: 22,
    eligibility: { classes: ['A'], zones: 'all', installIncluded: false },
    requiresAr: [
      'بيع الخدمة عند نقطة البيع مع الجهاز الجديد',
      'مساحة على المركبة للجهاز القديم في رحلة العودة',
      'جهة معتمدة لإعادة التدوير أو التخلص',
    ],
    requiresEn: [
      'Sold at the point of sale alongside the new appliance',
      'Space on the vehicle for the old unit on the return leg',
      'An approved recycling or disposal route',
    ],
  },
  {
    id: 'same_day',
