...
/**
 * Product catalogue modelled on a typical appliance-retailer portfolio (docs/01 §2): a house
 * brand (Dar — fictional) alongside the major global brands in white goods, small appliances
 * and kitchenware.
 *
...
export const PRODUCTS: Product[] = [
  ...
  { sku: 'DAR-RF-310', nameAr: 'ثلاجة دار ٣١٠ لتر', nameEn: 'Dar Refrigerator 310L', brand: 'Dar', category: 'refrigerator', productClass: 'A', cubeM3: 0.88, weightKg: 68, fragile: false, stackable: false, installType: 'none', crewRequired: 2, handlingMinutes: 12, installMinutes: 0, dimensionsEstimated: true },
  ...
  { sku: 'DAR-CK-60', nameAr: 'غاز دار ٦٠ سم', nameEn: 'Dar Gas Cooker 60cm', brand: 'Dar', category: 'cooker', productClass: 'A', cubeM3: 0.45, weightKg: 55, fragile: false, stackable: false, installType: 'gas', crewRequired: 2, handlingMinutes: 10, installMinutes: 28, dimensionsEstimated: true },
  { sku: 'DAR-OV-BI', nameAr: 'فرن دار مدمج', nameEn: 'Dar Built-in Oven', brand: 'Dar', category: 'oven', productClass: 'A', cubeM3: 0.18, weightKg: 34, fragile: false, stackable: false, installType: 'electrical', crewRequired: 2, handlingMinutes: 8, installMinutes: 30, dimensionsEstimated: true },
  ...
  { sku: 'DAR-TV-43', nameAr: 'شاشة دار ٤٣ بوصة', nameEn: 'Dar TV 43"', brand: 'Dar', category: 'television', productClass: 'A', cubeM3: 0.14, weightKg: 12, fragile: true, stackable: false, installType: 'none', crewRequired: 1, handlingMinutes: 5, installMinutes: 0, dimensionsEstimated: true },
